...
COPY public.blackhole (blackhole_id, gravity, galaxy_id, wormhole, name, name_code) FROM stdin;
1	\N	\N	f	skouliki	1
2	\N	\N	t	aris	2
3	\N	\N	t	myrmigki	3
\.
...
COPY public.galaxy (galaxy_id, name, speed, description, name_code) FROM stdin;
2	ANDROMEDA	\N	\N	1
3	ANDR	\N	\N	2
4	ANR	\N	\N	3
5	AR	\N	\N	4
...
COPY public.planet (planet_id, name, amount_of_people, time_travel, star_id, name_code) FROM stdin;
1	alpha	\N	f	1	1
3	alph	\N	f	2	2
4	alp	\N	f	3	3
5	alp	\N	f	3	4
...
COPY public.star (star_id, name, radius, color, galaxy_id, name_code) FROM stdin;
1	paokara	1	black	2	1
2	paokar	2	black	3	2
3	paoka	3	black	3	3
4	paok	4	black	4	4
5	pao	5	black	5	5
6	po	6	black	6	6
